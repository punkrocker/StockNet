...
--
-- Table structure for table `st_owner`
--

DROP TABLE IF EXISTS `st_owner`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `st_owner` (
  `Id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `st_owner`
--

LOCK TABLES `st_owner` WRITE;
/*!40000 ALTER TABLE `st_owner` DISABLE KEYS */;
/*!40000 ALTER TABLE `st_owner` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2015-08-04  8:02:35
