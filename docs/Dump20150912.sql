...
CREATE TABLE `st_goods` (
  ...
  `RecommendPic` varchar(550) DEFAULT NULL,
  PRIMARY KEY (`Id`),
  UNIQUE KEY `Name_UNIQUE` (`Name`)
...
-- Dump completed on 2015-09-12 18:11:39
